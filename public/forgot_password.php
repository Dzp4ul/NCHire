...
<body class="gt-app gt-auth-shell relative min-h-screen flex items-center justify-center p-4" style="background-image: url('assets/images/520382375_1065446909052636_3412465913398569974_n.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
    <!-- Dark Overlay -->
