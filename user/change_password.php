...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($new_password) || empty($confirm_password)) {
        ...
        $stmt = $conn->prepare("UPDATE applicants SET applicant_password = ?, password_change_required = 0 WHERE id = ?");
        ...
        if ($stmt->execute()) {
            ...
            header("Refresh: 2; URL=../public/index.php?open_login=1");
        } else {
...
<head>
    ...
    <title>Change Password - NCHire</title>
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
            <div class="text-center mb-6">
                <div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="ri-key-2-line text-amber-600 text-2xl"></i>
                </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-gray-700">
                            <strong>Logged in as:</strong> <?php echo htmlspecialchars($_SESSION['first_name'] ?? 'User'); ?><br>
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="ri-lock-password-line mr-2"></i>New Password
                        </label>
                        <div class="relative">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="ri-lock-password-line mr-2"></i>Confirm New Password
                        </label>
                        <div class="relative">
            ...
            <div class="mt-6 text-center">
                <a href="../public/index.php?logout=1" class="text-sm text-gray-600 hover:text-gray-800">
